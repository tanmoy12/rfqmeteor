...
export default class AllowanceNikosh extends Component {
                                ...
                                <table className="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>বৈজ্ঞানিক কর্মকর্তা <br/>
                                            ...
                                            ও সভাপতি, স্বল্পমূল্যের ক্রয়ের জন্য দরপত্র <br/> ও প্রস্তাব মূল্যায়ন কমিটি
                                        </td>
                                        <td>......................</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>প্রধান বৈজ্ঞানিক কর্মকর্তা <br/>
                                            ...
                                            পরমানু শক্তি কেন্দ্র, ঢাকা ও সদস্য, <br/> স্বল্পমূল্যের ক্রয়ের জন্য দরপত্র
                                            <br/>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>ড. বিলকিস আরা বেগম <br/>
                                                ...
                                                ও বিভাগীয় প্রধান, রসায়ন বিভাগ, <br/>
                                                পরমানু শক্তি কেন্দ্র, ঢাকা ও <br/>সদস্য, স্বল্পমূল্যের ক্রয়ের জন্য দরপত্র <br/>
                                                ও প্রস্তাব মূল্যায়ন কমিটি
                                            </td>
                                            <td scope="colgroup">৩০০/-</td>
                                            <td scope="colgroup">৩০/- </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>সুমাইয়া আক্তার <br/>
                                                বৈজ্ঞানিক কর্মকর্তা <br/>
                                                ডিআরআইসিএম, বিসিএসআইআর <br/>
                                                ও সদস্য-সচিব, স্বল্পমূল্যের ক্রয়ের জন্য দরপত্র <br/>ও প্রস্তাব মূল্যায়ন কমিটি
                                            </td>
                                            <td scope="colgroup">৩০০/-</td>
                                            <td scope="colgroup">৩০/- </td>
                                            <td scope="colgroup">২৭০/-</td>
