                            ...
                            <div className="table table-bordered table-responsive">
                                <table className="table">
                                    ...
                                    <tr>
                                        ...
                                        <td id="nss">SAS Corporation
                                            Shahera Tropical Center(7th Floor), Suit No: 12, 218 Elephant Road, Dhaka-
                                            1205.
                                        </td>
                                        <td id="nss">RG Associates
                                            L3- 101, B S Bhaban (3rd Floor), 75- 76, Laboratory Road, Dhaka- 1205.
                                        </td>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tr>
                                        <td>b</td>
                                        <td>Offered price</td>
                                        <td><strong>1,40,000.00 Tk
                                            (One Lac Forty Thousand taka only)</strong>
                                        </td>
                                        <td><strong>1,50,150.00 Tk.
                                            (One Lac Fifty Thousand One Hundred Fifty taka only) </strong>
                                        </td>
                                        <td><strong>1,53,700.00 Tk.
                                            (One Lac Forty Three Thousand Seven Hundred taka only)</strong>
                                        </td>
                                    </tr>
                    ...
                    <div className="table table-bordered table-responsive">
                        <table className="table">
                            ...
                            <tr>
                                ...
                                <td>Millennium Dreams Co.
                                    Mamun Plaza, Shop-127(G.F), 31 Hatkhola Road, Tikatuli, Dhaka- 1203.
                                </td>
                                <td>SAS Corporation
                                    Shahera Tropical Center(7th Floor), Suit No: 12, 218 Elephant Road, Dhaka- 1205.
                                </td>
                                <td>RG Associates
                                    L3- 101, B S Bhaban (3rd Floor), 75- 76, Laboratory Road, Dhaka- 1205.
                                </td>
